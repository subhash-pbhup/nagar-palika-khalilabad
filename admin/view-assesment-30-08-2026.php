...
| STATUS FILTER
|--------------------------------------------------------------------------
| Pending / Rejected / Approved filters are global.
| Verification permission is checked inside verify-assessment.php.
|--------------------------------------------------------------------------
*/
// OR filter group
$orConditions = [];
        ...
        <div class="glass rounded-2xl p-6">
            <div class="flex items-center justify-between mb-4 gap-4 flex-wrap">
                ...
                <!-- <p class="text-xs text-gray-500 mt-1">
                    <i class="fa fa-history text-purple-600"></i> Assessment Update History
                    &nbsp; | &nbsp;
                    <i class="fa fa-check-circle text-indigo-600"></i> Verification History
                </p> -->
